...
AS $$
DECLARE
  project_url TEXT := 'https://hhqyoslqxkbjhhzcxsbr.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhocXlvc2xxeGtiamhoemN4c2JyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjE5OTc5NSwiZXhwIjoyMDIxNzc1Nzk1fQ.zWvZeu5Yf92yhugLzcKH7eTi2ngV7BbbU-cBK-a26bg'; -- full access needed for http request to storage
